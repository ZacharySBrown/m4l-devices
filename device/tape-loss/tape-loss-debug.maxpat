		...
		"boxes": [
			...
			},
			{
				"box": {
					...
					"text": "DEBUG harness for tape-loss: 440Hz sine \u2192 device \u2192 ezdac~. Open in Max IDE, click loadbang, verify zero console errors (pitfall #9)."
				}
			}
		],
		"lines": [
